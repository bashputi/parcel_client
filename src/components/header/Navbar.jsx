...
const Navbar = () => {
  ...
  const { user } = useAuth();
    ...
    const Navlink = <>
       ...
       <li className=" font-semibold"><NavLink to="/" className={({ isActive, isPending }) => isPending ? "pending" : isActive ? "text-[#d78131] font-semibold uppercase underline" : "" }>DASHBOARD</NavLink></li>
