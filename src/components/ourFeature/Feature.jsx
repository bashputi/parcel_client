...
const Feature = () => {
    return (
        <div className="my-20">
            <h1 data-aos="zoom-in" data-aos-duration="3000"  className="font-extrabold text-4xl text-[#d78131] text-center mb-20">Our Features</h1>
            <div className="flex justify-center">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div data-aos="flip-down" data-aos-duration="1500" className="card px-5 w-96 bg-base-100 shadow-xl">
                ...
                <div data-aos="flip-down" data-aos-duration="2500" className="card px-5 w-96 bg-base-100 shadow-xl">
                ...
                <div data-aos="flip-down" data-aos-duration="3500" className="card px-5 w-96 bg-base-100 shadow-xl">
